...
# Deprecated
def write_h5ad_deprecated(adata, filename, use_raw=False):
    """Write AnnData object as h5ad
...
def write_loom_deprecated(adata, filename, layer=None, use_raw=False):
    """Write AnnData object as loom that is compatible with SCENIC
...
def write_tsv_deprecated(adata, filename="expr.tsv", layer=None, use_raw=False):
    """Write AnnData matrix as tsv
