# DEPRECATED: I would argue this step is almost too specific to the way the data is organized and should be done in a notebook. It won't take overly long to do abd you can let run
