#!/usr/bin/env bash
#SBATCH --job-name=cistopic_cgs
#SBATCH --output=%x_%j.out
#SBATCH --error=%x_%j.err
#SBATCH --ntasks=1

# 02_run_models_cgs.sh — Train LDA topic models using Collapsed Gibbs Sampling.
#
# Usage:
#   sbatch slurm/02_run_models_cgs.sh
#
# Requires CISTOPIC_OBJ to be set in config.sh (output of step 01).
...
# --- Create directories ---
mkdir -p "${LOG_DIR}"
MODELS_OUTPUT="${OUTPUT_BASE}/models_cgs"
