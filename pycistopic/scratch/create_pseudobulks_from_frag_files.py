...
def main(args):
    ...
    # Make sure all sample_ids are found in metadata
    if not set(sample_ids).issubset(set(metadata[args.sample_id_column])):
        logging.error("Not all sample_ids are found in the metadata.")
        return
